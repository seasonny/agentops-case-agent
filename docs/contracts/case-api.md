...
| | |
|---|---|
| **Purpose** | 定義 Case Portal MCP 工具與 JSON 回傳契約 |
| **Audience** | MCP Server 團隊、整合工程師 |
| **Source of truth** | 本文件是 **Case API 整合契約**的權威來源 |
| **Related** | [contracts/exec-mcp.md](exec-mcp.md)、[architecture/04-module-map.md](../architecture/04-module-map.md) |

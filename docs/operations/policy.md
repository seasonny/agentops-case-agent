...
| | |
|---|---|
| **Purpose** | 說明如何配置 `config/policy.yaml` 與能力包 |
| **Audience** | SRE、客戶、資安審計人員 |
| **Source of truth** | 本文件是 **policy.yaml 操作**的權威來源 |
| **Related** | [architecture/05-vocabulary.md](../architecture/05-vocabulary.md) § Policy / Capability、[guides/developer.md](../guides/developer.md) |

...
| | |
|---|---|
| **Purpose** | 說明如何新增與配置 MCP provider |
| **Audience** | 整合工程師、平台工程師 |
| **Source of truth** | 本文件是 **MCP provider 擴充**的權威來源 |
| **Related** | [contracts/exec-mcp.md](../contracts/exec-mcp.md)、[operations/policy.md](../operations/policy.md)、[architecture/04-module-map.md](../architecture/04-module-map.md) |
